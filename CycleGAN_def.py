...
def save_models(step, g_model_AtoB, g_model_BtoA):
	...
	filename1 = './drive/MyDrive/Colab Notebooks/Domain Adaptation/Saved_modelsGAN/g_model_AtoB_%06d.h5' % (step+1)
	g_model_AtoB.save(filename1)
	# save the second generator model
	filename2 = './drive/MyDrive/Colab Notebooks/Domain Adaptation/Saved_modelsGAN/g_model_BtoA_%06d.h5' % (step+1)
	g_model_BtoA.save(filename2)

	wts_AtoB = g_model_AtoB.get_weights()
	wts_BtoA = g_model_BtoA.get_weights()
	fn1 = './drive/MyDrive/Colab Notebooks/Domain Adaptation/Saved_wtsGAN/g_model_AtoB_%06d.npy' % (step+1)
	fn2 = './drive/MyDrive/Colab Notebooks/Domain Adaptation/Saved_wtsGAN/g_model_BtoA_%06d.npy' % (step+1)
